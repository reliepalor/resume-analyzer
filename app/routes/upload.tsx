    ...
    const handleAnalyze = async ({companyName, jobTitle, jobDescription, file}: {companyName: string, jobTitle: string, jobDescription: string, file: File}) => {
        ...
        const feedback = await ai.feedback(
            ...
            prepareInstructions({
                jobTitle,
                jobDescription,
                AIResponseFormat: "text" // or use the appropriate format required by your app
            })
        );
       ...
       setStatusText('Analysys complete, redirecting...');
       console.log(data);
        ...
        <section className="main-section">
            <div className='page-heading py-16 '>
                ...
                {isProcessing ? (
                    <>
                        <h2>{statusText}</h2>
                        <img src="/images/resume-scan.gif" alt="" className='w-45 h-45'/>
